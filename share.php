            ...
            return fetch(`api.php?action=get_share_audit&token=${encodeURIComponent(token)}`)
                ...
                .then(data => {
                    ...
                    if (isScreenshotPath(breakdownVal)) {
                        breakdownContainer.innerHTML = `<img src="${breakdownVal}" style="width: 100%; height: 180px; object-fit: cover; border-radius: var(--radius-sm); border: 1px solid var(--border-glass); cursor: zoom-in;" onclick="openImageLightbox(this.src)">`;
                    } else {
                                    ...
                                    <div class="form-group" style="height: 100%; display: flex; flex-direction: column; margin-bottom: 0;">
                                        ...
                                        <div style="flex-grow: 1; display: flex; flex-direction: column; height: 100%;">
                                            ${isScreenshotPath(c.breakdown_by_country) ? `
                                                <div style="background:rgba(255,255,255,0.02); padding:8px; border-radius:6px; border:1px solid var(--border-glass); flex-grow:1; display:flex; align-items:center; justify-content:center; min-height:180px; height: 180px;">
                                                    <img src="${escapeHtml(c.breakdown_by_country)}" style="width:100%; height:100%; min-height:164px; max-height:164px; object-fit:cover; border-radius:4px; cursor:zoom-in;" onclick="openImageLightbox(this.src)">
                                                </div>
                                            ` : `
